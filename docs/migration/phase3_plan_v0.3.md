...
> **保存場所**: `D:\tagdeck\docs\migration\phase3_plan_v0.3.md`
...
> **並行実施**: Phase 3a-4（AI接客カンペ）と Phase 3a-5（リスナーCRM）は Phase 3a-3 完了後に並行実施可。DB設計の競合がないことを事前確認すること（§13 EXT_AUDIT 観点 A1 参照）。
...
| R4 | Groq 試食キーの技術的レート上限到達(発生時 BYOK 強制誘導の摩擦が発生) | 中 | 中 | BYOK 誘導強化・Gemini Free / Claude Haiku へのフォールバック |
...
*以上。Phase 3 計画書 v0.3 終了。v1.0 化は EXT_AUDIT レビュー + 社長承認後。*
